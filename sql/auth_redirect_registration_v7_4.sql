-- =========================================================
-- TONI – Auth V7.4 / Nach Verifizierungslink Registrierung öffnen
...
-- Anonym darf nur prüfen, ob vollständiges aktives Profil existiert.
...
-- Angemeldete Nutzer dürfen eigenes Profil lesen.
...
-- Angemeldete Nutzer dürfen eigenes Profil anlegen, falls Trigger noch nicht fertig war.
...
-- Angemeldete Nutzer dürfen eigenes Profil vervollständigen.
