...
// Die App-Shell: alles, was der Player zum Offline-Start braucht.
const SHELL_FILES = [
  "./",
  "./index.html",
  "./manifest.json",
  "./journey.js",
  "./journey/theme/journey_theme.js",
];
...
self.addEventListener("fetch", (event) => {
  ...
  if (url.origin === self.location.origin) {
    // Dynamisch nachgeladene Theme-Skripte (/journey/theme/*.js) cachen,
    // damit das Theme beim nächsten Offline-Start verfügbar ist.
    if (url.pathname.indexOf("/journey/theme/") !== -1) {
      event.respondWith(
