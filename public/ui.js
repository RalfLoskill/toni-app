...
/* =========================================================
   TONI V83-DIAG – Ladevorhang-Diagnose. Aktiv via #loaddiag (bleibt dann
   über Reloads aktiv, bis #loaddiag-off). Protokolliert reload-übergreifend
   in sessionStorage. Harmlos im Normalbetrieb.
   ========================================================= */
(function(){
  const KEY = "TONI_LOADDIAG";
  const LOGKEY = "TONI_LOADDIAG_LOG";

  // Aktivierung / Deaktivierung über URL-Hash
  if (location.hash === "#loaddiag") { sessionStorage.setItem(KEY, "1"); }
  if (location.hash === "#loaddiag-off") { sessionStorage.removeItem(KEY); sessionStorage.removeItem(LOGKEY); }
