...
`;
  ...
  window.toniThemes.register({
    ...
    renderPreview: function () {
      // Mini-Sternenhimmel mit Flugbahn + zwei Planeten + Zielstern.
      let stars = "";
      for (let i = 0; i < 22; i++) {
      ...
      return '<svg viewBox="0 0 160 100" xmlns="http://www.w3.org/2000/svg">' +
        '<defs><linearGradient id="spPv" x1="0" y1="1" x2="0" y2="0">' +
        '<stop offset="0" stop-color="#FF7A3C"/><stop offset="1" stop-color="#FFC857"/></linearGradient></defs>' +
        '<rect width="160" height="100" rx="10" fill="#0C1024"/>' +
        '<rect width="160" height="100" rx="10" fill="url(#spPv)" opacity="0.06"/>' +
        stars +
        '<path d="M30 86 C60 70 50 50 80 44 C110 38 100 24 128 16" fill="none" ' +
          'stroke="url(#spPv)" stroke-width="2.5" stroke-linecap="round"/>' +
        '<circle cx="55" cy="58" r="9" fill="#2E6B52"/>' +
        '<circle cx="95" cy="40" r="9" fill="#3a4a86"/>' +
        '<path d="M128 10 l2 5 5 0 -4 3 1.5 5 -4.5 -3 -4.5 3 1.5 -5 -4 -3 5 0 z" fill="#FFC857"/>' +
        '</svg>';
    }
  });

  console.info("[TONI-Theme:space] Weltall-Theme registriert (theme-space-v9-preview).");
})();
