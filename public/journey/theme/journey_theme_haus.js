 ...
 * Build: theme-haus-v3-fullscreen
 *
...
body.toni-haus-fullscreen #lr-modal.toni-theme-active-haus .lr-modal-actions{width:auto !important;gap:8px !important;}
body.toni-haus-fullscreen #lr-modal.toni-theme-active-haus .lr-modal-actions button{
  flex:0 0 auto !important;background:rgba(23,16,25,.72) !important;color:${ACCENT} !important;
...
`;
  ...
  console.info("[TONI-Theme:haus] Wissenshaus-Theme registriert (theme-haus-v3-fullscreen).");
})();
