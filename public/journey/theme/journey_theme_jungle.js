...
(function () {
  ...
  function injectStyles() {
    ...
    const css =
      ...
      "body.toni-jungle-fullscreen #lr-modal.toni-theme-active-jungle.lr-modal-backdrop{" +
        "position:fixed;inset:0;width:100vw;height:100vh;max-width:none;border-radius:0;padding:0;margin:0;}" +
      ...
      "body.toni-jungle-fullscreen #lr-modal.toni-theme-active-jungle > div{" +
        "max-width:none;width:100%;height:100%;border-radius:0;margin:0;}" +
      "body.toni-jungle-fullscreen #lr-modal.toni-theme-active-jungle .lr-modal-body{" +
        "max-height:none;height:100%;overflow-y:auto;overscroll-behavior:contain;background:" + GREEN_DARK + ";}" +
  ...
  function renderStations(journey) {
    ...
    return '<div class="toni-jungle" style="position:relative;width:100%;">' +
  ...
  console.info("[TONI-Theme:jungle] Dschungel-Theme registriert (theme-jungle-v1).");
})();
