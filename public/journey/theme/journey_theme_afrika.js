 ...
 * Build: theme-afrika-v3-tageslauf
 *
...
@keyframes afSunRise{0%{transform:translateY(150px);opacity:.2}
  25%{transform:translateY(0);opacity:1}70%{transform:translateY(0);opacity:1}
  100%{transform:translateY(150px);opacity:.2}}
...
/* Wolken ziehen von links nach rechts (zwei langsam, zwei schneller) */
...
'</svg>';
  ...
  console.info("[TONI-Theme:afrika] London-Theme registriert (theme-afrika-v3-tageslauf).");
})();
