...
/* Vogelschwarm zieht über den Himmel */
@keyframes afBirds{0%{transform:translate(-120px,40px)}100%{transform:translate(1320px,-10px)}}
...
'<svg viewBox="0 0 1220 300" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMax slice">' +
  ...
  // ===== Tiere (animiert) =====
  // Löwe (Mähne, döst – atmet)
  '<g class="af-breathe" style="transform-origin:300px 220px">' +
    '<ellipse cx="330" cy="225" rx="48" ry="22" fill="#C98A4A"/>' +
    '<rect x="318" y="232" width="6" height="16" rx="3" fill="#A06A2E"/><rect x="352" y="232" width="6" height="16" rx="3" fill="#A06A2E"/>' +
    '<circle cx="288" cy="210" r="26" fill="#7A4A1E"/><circle cx="288" cy="210" r="16" fill="#E0A44E"/>' +
    '<circle cx="282" cy="207" r="2.5" fill="#3A2410"/><circle cx="294" cy="207" r="2.5" fill="#3A2410"/>' +
  '</g>' +
  // Trommeln am Ufer
  '<g transform="translate(430,228)"><path d="M0 0 h44 l-8 44 h-28 z" fill="#fff" stroke="#7A5230" stroke-width="3"/>' +
    '<ellipse cx="22" cy="0" rx="22" ry="6" fill="#C98A4A"/>' +
    '<line x1="2" y1="6" x2="14" y2="40" stroke="#7A5230" stroke-width="2"/><line x1="42" y1="6" x2="30" y2="40" stroke="#7A5230" stroke-width="2"/></g>' +
  '<ellipse cx="500" cy="250" rx="20" ry="16" fill="#9A6A38"/>' +
  // Figur mit Wasserkrug (wiegt sich leicht)
  '<g class="af-sway" style="transform-origin:610px 250px">' +
    '<ellipse cx="610" cy="120" rx="22" ry="16" fill="#5A3A22"/>' + // Krug
    '<rect x="600" y="132" width="20" height="14" fill="#5B9E3A"/>' +
    '<circle cx="610" cy="158" r="16" fill="#6B4A2B"/>' + // Kopf
    '<rect x="600" y="172" width="20" height="40" rx="6" fill="#5A3A22"/>' +
    '<path d="M600 212 h20 l8 38 h-36 z" fill="#3E7D2A"/>' + // Rock
    '<rect x="592" y="176" width="7" height="34" rx="3" fill="#6B4A2B"/><rect x="621" y="176" width="7" height="34" rx="3" fill="#6B4A2B"/>' +
  '</g>' +
  // Elefant (Rüssel schwingt)
  ...
  '<g transform="translate(1090,120)">' +
    ...
    '<rect x="28" y="128" width="8" height="34" rx="3" fill="#C98A3A"/><rect x="50" y="128" width="8" height="34" rx="3" fill="#C98A3A"/>' +
...
'</svg>';
  ...
  console.info("[TONI-Theme:afrika] London-Theme registriert (theme-afrika-v1).");
})();
