 ...
 * Build: theme-afrika-v7-mobilecrop
 *
...
/* Handy hochkant: nur mittlerer Ausschnitt (linker bis rechter Baum), ca. 1/3 Höhe */
@media (max-width:640px){
  .toni-afrika__skyline{height:34vh;min-height:200px;max-height:300px;}
  /* SVG breiter als Container + zentriert => mittlerer Bereich sichtbar, Ränder beschnitten */
  .toni-afrika__skyline svg{
    position:absolute;left:50%;bottom:0;transform:translateX(-50%);
    width:auto;height:115%;min-width:560px;}
}
...
'</svg>';
  ...
  console.info("[TONI-Theme:afrika] London-Theme registriert (theme-afrika-v7-mobilecrop).");
})();
