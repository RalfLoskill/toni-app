...
@keyframes afWalkEleph{
  0%{transform:translate(1320px,150px)}
  18%{transform:translate(1320px,150px)}
  42%{transform:translate(480px,150px)}
  62%{transform:translate(480px,150px)}
  90%{transform:translate(-220px,150px)}
  100%{transform:translate(-220px,150px)}}
...
.af-walk-eleph .af-trunk{transform-box:fill-box;transform-origin:-14px 36px;
...
.toni-afrika__tico{width:34px;height:34px;flex:0 0 34px;border-radius:10px;display:grid;place-items:center;
  background:color-mix(in srgb,var(--cc,#E58A2E) 22%,#fff);color:var(--cc,#E58A2E);
  border:1px solid color-mix(in srgb,var(--cc,#888) 45%,transparent);}
...
@media (prefers-reduced-motion: reduce){
  ...
  .af-walk-eleph{transform:translate(480px,150px);}
...
'<svg viewBox="0 0 1220 300" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMax slice">' +
  ...
  // Zebra grast unter dem rechten Baum (Blick nach links)
  '<g transform="translate(770,196)">' +
    '<ellipse cx="0" cy="44" rx="46" ry="22" fill="#F2EFE9"/>' +
    // Streifen am Körper
    '<g stroke="#2E2A26" stroke-width="5">' +
      '<line x1="-30" y1="28" x2="-30" y2="60"/><line x1="-18" y1="24" x2="-18" y2="64"/>' +
      '<line x1="-6" y1="23" x2="-6" y2="65"/><line x1="6" y1="23" x2="6" y2="65"/>' +
      '<line x1="18" y1="24" x2="18" y2="64"/><line x1="30" y1="28" x2="30" y2="60"/>' +
    '</g>' +
    // Beine
    '<rect x="-34" y="60" width="8" height="26" rx="3" fill="#E9E4DC"/><rect x="-14" y="62" width="8" height="26" rx="3" fill="#E9E4DC"/>' +
    '<rect x="10" y="62" width="8" height="26" rx="3" fill="#E9E4DC"/><rect x="28" y="60" width="8" height="26" rx="3" fill="#E9E4DC"/>' +
    // Schweif
    '<path d="M44 36 q14 6 10 24" stroke="#2E2A26" stroke-width="4" fill="none"/>' +
    // Kopf nach links unten (grasend, animiert)
    '<g class="af-graze" style="transform-origin:-44px 34px">' +
      '<path d="M-44 34 q-24 4 -30 26 q-2 8 8 8 q16 -2 22 -14 z" fill="#F2EFE9"/>' +
      '<line x1="-56" y1="40" x2="-66" y2="58" stroke="#2E2A26" stroke-width="4"/>' +
      '<line x1="-48" y1="36" x2="-56" y2="56" stroke="#2E2A26" stroke-width="4"/>' +
      '<rect x="-50" y="22" width="5" height="12" rx="2" fill="#2E2A26"/>' + // Mähne
      '<circle cx="-62" cy="52" r="2.4" fill="#2E2A26"/>' + // Auge
    '</g>' +
    // Grasbüschel am Boden
...
'</svg>';
  ...
  console.info("[TONI-Theme:afrika] London-Theme registriert (theme-afrika-v4-zebra).");
})();
