...
body.toni-london-fullscreen #lr-modal.toni-theme-active-london .lr-modal-actions button{
  background:#fff !important;border:2px solid ${ROYAL} !important;color:${ROYAL} !important;}
...
'</svg>';
  ...
  console.info("[TONI-Theme:london] London-Theme registriert (theme-london-v2-gridfix).");
})();
