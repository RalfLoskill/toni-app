...
(function () {
  ...
  async function loadCosts() {
    ...
    try {
      ...
      $("cost-total").textContent = B.euro(Number(tot.total_eur || 0));
      $("cost-month").textContent = B.euro(Number(tot.this_month_eur || 0));
  ...
  function renderResult(p) {
    ...
    var cost = p.usage && p.usage.cost_eur != null ? " · Kosten: " + B.euro(p.usage.cost_eur) : "";
