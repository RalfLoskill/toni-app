...
function renderProjectsDashboard() {
  ...
  wrap.innerHTML = projects.map(p => {
    ...
    return `<div data-project-id="${p.id}" onclick="openProjectModal('${p.id}')" style="cursor:pointer;background:${pal.bgGradient||pal.bg};border:0.5px solid ${pal.border};border-radius:10px;padding:10px 12px;margin-bottom:8px;transition:opacity .15s"
