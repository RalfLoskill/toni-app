    ...
    return `<div class="v111-rxcard v111-lerncard">
      ...
      <div class="v111-lerntoolbar">
        ...
        <button type="button" class="v111-lernbtn v111-lernbtn-icon" title="Aufzählung (Punkte)"
          onmousedown="event.preventDefault()" onclick="TONI_EDITOR_V111_UI.contentCmd(${si},${ti},'list')"><span class="v111-listdots"></span></button>
        <button type="button" class="v111-lernbtn" title="Nummerierte Aufzählung (1. 2. 3.)"
          onmousedown="event.preventDefault()" onclick="TONI_EDITOR_V111_UI.contentCmd(${si},${ti},'orderedlist')">1.2.3.</button>
