...
(function(){
    ...
    host.innerHTML =
      `<div class="v111-wrap">
        ...
        <div class="v111-col">
          ...
          <div id="v111-preview-slot">${previewHtml(arr)}</div>
        </div>
      </div>
  ...
  function updatePreviewOnly(){
    const slot = document.getElementById("v111-preview-slot");
    if(slot){ slot.innerHTML = previewHtml(stations()); }
    else { render(); }
  }
  ...
  function injectStyles(){
    ...
    css.textContent = `
      ...
      ${S} .v111-wrap{display:grid!important;grid-template-columns:1fr 1fr!important;gap:14px!important}
      @media(max-width:700px){${S} .v111-wrap{grid-template-columns:1fr!important}}
      ${S} .v111-coltitle{font-size:11px!important;font-weight:500!important;color:var(--color-text-tertiary)!important;text-transform:uppercase!important;letter-spacing:.05em!important;margin:0 0 8px!important}
      ${S} .v111-head{background:var(--color-background-primary)!important;border:0.5px solid var(--color-border-tertiary)!important;border-radius:12px!important;padding:12px 14px!important;margin-bottom:8px!important}
      ${S} .v111-headtitle{width:100%!important;border:none!important;background:none!important;padding:0!important;margin:0 0 4px!important;font-size:14px!important;font-weight:500!important;color:var(--color-text-primary)!important;font-family:inherit!important;outline:none!important}
      ${S} .v111-headgoal{width:100%!important;border:none!important;background:none!important;padding:0!important;margin:0!important;font-size:12px!important;color:var(--color-text-secondary)!important;font-family:inherit!important;outline:none!important}
      ${S} .v111-station{background:var(--color-background-primary)!important;border:0.5px solid var(--color-border-tertiary)!important;border-radius:12px!important;margin-bottom:8px!important;overflow:hidden!important}
      ...
      ${S} .v111-grip{color:var(--color-text-tertiary)!important;cursor:grab!important;font-size:14px!important;line-height:1!important}
      ${S} .v111-grip-sm{font-size:12px!important}
      ${S} .v111-stationtitle{flex:1!important;font-size:13px!important;font-weight:500!important;color:var(--color-text-primary)!important}
      ${S} .v111-count{font-size:11px!important;color:var(--color-text-tertiary)!important}
      ${S} .v111-chev{color:var(--color-text-tertiary)!important;font-size:12px!important}
      ${S} .v111-stationbody{padding:0 12px 12px!important}
      ${S} .v111-inp{width:100%!important;box-sizing:border-box!important;padding:8px 10px!important;border:0.5px solid var(--color-border-secondary)!important;border-radius:8px!important;font-size:13px!important;background:var(--color-background-primary)!important;color:var(--color-text-primary)!important;margin-bottom:6px!important;font-family:inherit!important;outline:none!important}
      ...
      ${S} .v111-taskrow{display:flex!important;align-items:center!important;gap:7px!important;padding:7px 9px!important;border-radius:8px!important;cursor:pointer!important;background:var(--color-background-secondary)!important;margin-bottom:4px!important}
      ${S} .v111-taskname{flex:1!important;font-size:12px!important;font-weight:500!important}
      ${S} .v111-taskmeta{font-size:11px!important;color:var(--color-text-tertiary)!important}
      ${S} .v111-addtask,${S} .v111-addstation{display:flex!important;align-items:center!important;justify-content:center!important;gap:5px!important;font-size:12px!important;color:#185FA5!important;border:0.5px dashed var(--color-border-secondary)!important;border-radius:8px!important;padding:9px!important;cursor:pointer!important;margin-top:4px!important;background:none!important}
      ${S} .v111-stationactions{margin-top:8px!important;text-align:right!important}
      ${S} .v111-sbtn{font-size:12px!important;color:var(--color-text-secondary)!important;background:none!important;border:0.5px solid var(--color-border-secondary)!important;border-radius:8px!important;padding:6px 11px!important;cursor:pointer!important;font-family:inherit!important}
      ...
      ${S} .v111-preview{background:var(--color-background-primary)!important;border:0.5px solid var(--color-border-tertiary)!important;border-radius:12px!important;padding:14px!important}
      ${S} .v111-pvtitle{font-size:13px!important;font-weight:500!important;color:var(--color-text-primary)!important;margin:0!important}
      ${S} .v111-pvgoal{font-size:11px!important;color:var(--color-text-secondary)!important;margin:2px 0 10px!important}
      ${S} .v111-route{display:flex!important;align-items:center!important;gap:3px!important;margin:10px 0 14px!important}
      ${S} .v111-routedot{width:24px!important;height:24px!important;border-radius:50%!important;display:flex!important;align-items:center!important;justify-content:center!important;font-size:11px!important;flex-shrink:0!important;background:var(--color-background-secondary)!important;color:var(--color-text-tertiary)!important}
      ...
      ${S} .v111-routedot.trophy{background:var(--color-background-secondary)!important}
      ${S} .v111-routeline{flex:1!important;height:2px!important;background:var(--color-border-tertiary)!important;min-width:12px!important}
      ${S} .v111-routeline.done{background:#639922!important}
      ${S} .v111-pvstation{font-size:12px!important;font-weight:500!important;color:var(--color-text-primary)!important;margin-bottom:6px!important}
      ${S} .v111-pvtask{display:flex!important;flex-direction:column!important;background:var(--color-background-secondary)!important;border-radius:8px!important;padding:9px 11px!important;margin-bottom:5px!important}
      ${S} .v111-pvtask>span:first-child{font-size:12px!important;font-weight:500!important}
      ${S} .v111-pvmeta{font-size:11px!important;color:var(--color-text-secondary)!important;margin-top:2px!important}
      ${S} .v111-empty{font-size:12px!important;color:var(--color-text-tertiary)!important;padding:10px!important;text-align:center!important}
      ${S} .v111-panel{background:var(--color-background-secondary)!important;border:0.5px solid var(--color-border-tertiary)!important;border-radius:12px!important;padding:14px!important;margin-top:12px!important}
      ${S} .v111-panelhead{font-size:14px!important;font-weight:500!important;color:var(--color-text-primary)!important;margin-bottom:12px!important;padding-bottom:10px!important;border-bottom:0.5px solid var(--color-border-tertiary)!important}
      ${S} .v111-flabel{font-size:11px!important;color:var(--color-text-tertiary)!important;margin-bottom:5px!important}
      ${S} .v111-typerow{display:flex!important;gap:5px!important;flex-wrap:wrap!important;margin-bottom:10px!important}
      ${S} .v111-typebtn{font-size:12px!important;padding:6px 11px!important;border-radius:8px!important;background:var(--color-background-primary)!important;border:0.5px solid var(--color-border-tertiary)!important;color:var(--color-text-secondary)!important;cursor:pointer!important}
      ...
      ${S} .v111-toggle{display:flex!important;align-items:center!important;gap:7px!important;font-size:12px!important;color:var(--color-text-secondary)!important;cursor:pointer!important}
    `;
