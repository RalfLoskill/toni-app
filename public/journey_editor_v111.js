...
(function(){
  ...
  function injectStyles(){
    ...
    css.textContent = `
      ...
      /* ---- Stationskarten ---- */
      ${S} .v111-station{background:var(--v111-bg1)!important;border:1px solid var(--v111-b1)!important;border-left:5px solid var(--v111-accent)!important;border-radius:16px!important;margin-bottom:11px!important;overflow:hidden!important;box-shadow:0 6px 20px rgba(60,45,120,.07)!important;transition:box-shadow .18s ease,transform .18s ease!important}
      ${S} .v111-station:hover{box-shadow:0 12px 30px rgba(60,45,120,.13)!important}
      ${S} .v111-station.open{border-left-color:#2563eb!important;box-shadow:0 12px 30px rgba(60,45,120,.15)!important}
      ${S} .v111-stationhead{display:flex!important;align-items:center!important;gap:10px!important;padding:13px 14px!important;cursor:pointer!important}
      ...
      ${S} .v111-stationtitle{flex:1!important;font-size:14px!important;font-weight:750!important;color:var(--v111-t1)!important;letter-spacing:-.01em!important}
      ${S} .v111-count{font-size:11px!important;font-weight:700!important;color:var(--v111-accent)!important;background:#efeaff!important;border-radius:999px!important;padding:3px 10px!important}
      ${S} .v111-chev{color:var(--v111-accent)!important;font-size:12px!important}
      ${S} .v111-stationbody{padding:0 14px 14px!important}
      ...
      ${S} .v111-taskrow{display:flex!important;align-items:center!important;gap:9px!important;padding:9px 11px!important;border-radius:12px!important;cursor:pointer!important;background:#fbfaff!important;border:1px solid transparent!important;margin-bottom:6px!important;transition:.14s!important}
      ${S} .v111-taskrow:hover{background:#fff!important;border-color:#c7b8f6!important;transform:translateX(2px)!important}
      ${S} .v111-taskname{flex:1!important;font-size:12.5px!important;font-weight:600!important}
      ${S} .v111-taskmeta{font-size:10.5px!important;font-weight:700!important;color:var(--v111-t3)!important;background:#eef1fb!important;border-radius:999px!important;padding:3px 9px!important}
