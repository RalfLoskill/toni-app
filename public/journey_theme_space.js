...
@media (max-width:760px){
  ...
  /* === Randloses Vollbild: kein weißer Modal-Rahmen, Himmel bis an die Kante === */
  /* Backdrop ohne Innenabstand. */
  body.toni-space-fullscreen #lr-modal.toni-theme-active-space.lr-modal-backdrop{
    padding:0 !important;}
  /* Das innere Modal-Panel: kein weißer Hintergrund, kein Rand, keine runden Ecken,
     kein Schatten – der Sternenhimmel füllt randlos den ganzen Screen. */
  body.toni-space-fullscreen #lr-modal.toni-theme-active-space .lr-modal{
    background:transparent !important;border:none !important;border-radius:0 !important;
    box-shadow:none !important;width:100vw !important;height:100vh !important;
    max-width:none !important;max-height:none !important;}
  /* Body/Detail-Grid ohne Innenabstand, damit nichts einen Rahmen andeutet. */
...
`;
  ...
  console.info("[TONI-Theme:space] Weltall-Theme registriert (theme-space-v6-toniship).");
})();
