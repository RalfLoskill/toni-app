 ...
 * Build: theme-space-v7-fullbleed
 *
...
/* Inneres Modal-Panel: kein weißer Rahmen mehr – der Sternenhimmel füllt randlos. */
...
/* Body/Detail-Grid randlos und SCROLLBAR; unten Platz, damit auch der
   unterste Mond/Planet anklickbar bleibt (löst "unten nicht klickbar"). */
...
body.toni-space-fullscreen #lr-modal.toni-theme-active-space .lr-main-card{
  padding:0 !important;margin:0 !important;background:transparent !important;
  border:none !important;border-radius:0 !important;box-shadow:none !important;}
/* Die Sternenfläche darf NICHT clippen (sonst sind Monde am Rand nicht
   klickbar) und bekommt unten Scroll-Reserve. */
...
/* Zusätzliche Sicherheits-Reserve am Ende der Stationsspalte. */
...
`;
  ...
  console.info("[TONI-Theme:space] Weltall-Theme registriert (theme-space-v7-fullbleed).");
})();
