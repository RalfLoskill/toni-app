...
.toni-theme-active-space .lr-right-col{margin-top:18px;}
...
`;
        ...
        for (let m = 0; m < moonCount; m++) {
          ...
          moonsHTML +=
            `<div class="toni-space__moon ${moonLocked ? "locked" : ""}" ` +
              ...
              `<span class="toni-space__mlabel">${esc(t.title)}</span>` +
            `</div>`;
        }
      }
  ...
  console.info("[TONI-Theme:space] Weltall-Theme registriert (theme-space-v3-orbit).");
})();
