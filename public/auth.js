    ...
    try{
      ...
      try{
        if(typeof window.toniShowStartScreen === "function"){
          ...
          document.getElementById("toni-startscreen")?.classList.remove("hidden");
        }
  ...
  function setSuperAdminProfile(){
    ...
    try{
      if(typeof window.toniHideStartScreen === "function"){
        window.toniHideStartScreen();
      } else {
        document.getElementById("toni-startscreen")?.classList.add("hidden");
      }
